...
struct CategoryPreset: Identifiable, Equatable {
    ...
    func makeDraft() -> CategoryDraft {
        CategoryDraft(
            ...
            autoScoresRemainers: autoScoresRemainers,
            isLocked: isLocked
        )
    }
}
...
extension CategoryPreset {
    static let all: [CategoryPreset] = [
        ...
        CategoryPreset(name: "Remains", columnId: "RM", totalPicks: 3, pointsPerCorrectPick: 1, autoScoresRemainers: true, isLocked: false),
